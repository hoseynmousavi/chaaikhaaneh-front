...
class ModuleScopePlugin {
	...
	apply(resolver) {
		const {appSrcs} = this
		resolver.hooks.file.tapAsync("ModuleScopePlugin", (request, _, callback) => {
			...
			// Find a path from src to the requested file
			...
			if (
				...
				Object.defineProperty(scopeError, "__module_scope_plugin", {value: true, writable: false, enumerable: false})
