...
function LoginLayout({children, showBackBtn, title, desc, Icon, image, onBackClick}: Props) {
	return (
		<div className="login">
			...
			<div className="login-box">
				{showBackBtn && (
					<Button className="login-box-back" desktopType="ghost-on-surface-first" desktopIsSquare escapeStart onClick={onBackClick || router.back}>
						<LineArrowRightSvg />
					</Button>
				)}
