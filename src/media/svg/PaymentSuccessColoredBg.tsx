...
function PaymentSuccessColoredBg({className}: {className?: string}) {
	const id = useId()
	const id1 = useId()
	...
	return (
		<svg className={className} viewBox="0 0 360 800" fill="none">
			<g clipPath={`url(#${id1})`}>
				<rect width="360" height="800" fill={`url(#${id})`} />
				<path
					fillRule="evenodd"
					clipRule="evenodd"
			...
			<defs>
				<linearGradient id={id} x1="180" y1="0" x2="180" y2="800" gradientUnits="userSpaceOnUse">
					<stop stopColor="#25A754" />
					<stop offset="1" stopColor="#0E4121" />
				</linearGradient>
				<clipPath id={id1}>
...
export default PaymentSuccessColoredBg
